...
constructor. You normally don't need this, use the following to create an instance:
...
config files (Kernel/Config.pm, Kernel/Config/Defaults.pm, Kernel/Config/Files/*.(pm|xml)
except ZZZAAuto.pm) and their modification timestamps.
